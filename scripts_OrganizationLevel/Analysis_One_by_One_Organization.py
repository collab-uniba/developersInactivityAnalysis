...
for repo in org_repos:
    ...
    if project_name != main_project:
        ...
        if('commit_table_login.csv' in os.listdir(path)):
            ...
            print('No Commit for this project: '+project_name)
            continue
        ...
        with open(path+'/break_dates_list.csv', 'r') as f:
            #reader = csv.reader(f)
        ...
        ae.get_repo_activities(g, repo, project_url, project_start_dt, active_users)
        ...
        for index, row in active_users_df.iterrows():
            ...
            if 'actions_table.csv' in os.listdir(path):
                ...
                user_actions = ae.get_activities(g, repo, project_url, project_start_dt, project_end, user_id)
