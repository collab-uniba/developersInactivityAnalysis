...
FILE_TF_DEVS = 'TF_Results/{}/TF_devs.csv'
...
FILE_PAUSES = 'Organizations/{}/{}/coding_pauses_dates.csv' ## pauses_dates_list.csv ???
FILE_G_FULL_LIST = 'A80_Results/G_full_list.csv'
...
def get_path_to_TF_devs(owner: str, repository: str):
    ...
    """
    path_folder = get_path_to_folder()
    path = path_folder + '/' + FILE_TF_DEVS.format(repository)
    return path
